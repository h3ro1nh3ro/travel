...
- Name: smoke.spec.ts >> нижняя навигация — все кнопки ведут на рабочую страницу
- Location: tests/smoke.spec.ts:96:1
...
Call log:
  - navigating to "http://localhost:3000/video", waiting until "load"
